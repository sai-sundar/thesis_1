...
\DeclareAcronym{MLAP}
{short = MLAP , 
 long =most likely annihilation position}
\DeclareAcronym{TOF}{
	short=TOF,
	long=time of flight,
}
...
\DeclareAcronym{PDHG}{
	short=PDHG,
	long= primal-dual hybrid gradient,
}
\DeclareAcronym{MLTR}{
	short=MLTR,
	long=maximum likelihood for transmission tomography,
}
...
\DeclareAcronym{MSSIM}{
	short=MS-SSIM,
	long=multi scale structural similarity index,
}
\DeclareAcronym{MAE}{
	short=MAE,
