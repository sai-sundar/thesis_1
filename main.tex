...
\thesistitle{Tomographic Image Reconstruction with Direct Neural Network Approaches} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Dimitris \textsc{Visvikis},\\ Dr. Alexandre \textsc{Bousse}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
